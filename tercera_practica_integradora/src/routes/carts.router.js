...
router.post('/:cid/product/:pid', verifyTokenUser, cartsController.addProductToCart);
router.delete('/:cid/product/:pid', verifyTokenUser, cartsController.removeProductFromCart);
